...
1) Import Modules and Data
   - In this project, we utilized the following modules:
    ...
    - The dataset which was used was a sports balls image classification set from Kaggle.
          ...
          - https://www.kaggle.com/datasets/samuelcortinhas/sports-balls-multiclass-image-classification?select=train
